...
namespace OpenWeatherMap {
	...
	public class OpenWeatherMapException: Exception {
		...
		public OpenWeatherMapException( HttpResponseMessage response ): this( response.StatusCode ) {
			Response = response;
		}
		...
		public OpenWeatherMapException( Exception ex ): base( "OpenWeatherMap : an error occurred", ex ) {}
	}
}
