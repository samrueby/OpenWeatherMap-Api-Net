...
namespace OpenWeatherMap {
	...
	public class OpenWeatherMapClient: IOpenWeatherMapClient {
		...
		public ICurrentWeatherClient CurrentWeather { get { return new CurrentWeatherClient( new OpenWeatherMapRequest( OpenWeatherMapUrl, HttpClient, AppId ) ); } }

		/// <summary>
		/// Gets the forecast client.
		/// </summary>
		/// <value>The forecast.</value>
		public IForecastClient Forecast { get { return new ForecastClient( new OpenWeatherMapRequest( OpenWeatherMapUrl, HttpClient, AppId ) ); } }

		/// <summary>
		/// Gets the search client.
		/// </summary>
		/// <value>The search.</value>
		public ISearchClient Search { get { return new SearchClient( new OpenWeatherMapRequest( OpenWeatherMapUrl, HttpClient, AppId ) ); } }
